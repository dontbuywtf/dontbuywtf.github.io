...
const fileSystem = {
    ...
    'vault': { 
        dirs: ['restricted'], 
        files: { 
            'security_hint.txt': "THE DECRYPTION KEY SITS ON THE LEDGER.",
